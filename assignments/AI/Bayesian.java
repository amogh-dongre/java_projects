...
this.setModelDataLabelFair(data_table.getPriorProbability("Fair"),data_table.getLikeliHood(
"Interesting","Fair"),
data_table.getLikeliHood("Boring","Fair"),Double.parseDouble(taking.get(1).toString()),
Double.parseDouble(droping.get(1).toString()));
this.setModelDataLabelBad(data_table.getPriorProbability("Bad"),data_table.getLikeliHood(
"Interesting","Bad"),
data_table.getLikeliHood("Boring","Bad"),Double.parseDouble(taking.get(2).toString()),Double.parseDouble(droping.get(2).toString()));
this.setEvidence();
this.showResult();
}
private void setEvidence(){
this.evidence_interesting =
(good.getLikelihood_intresting()*good.getPrior_probability())+
...
private void setModelDataLabelGood(double prior_p,double likelihood_intresting,double
likelihood_boring,
...
private void setModelDataLabelFair(double prior_p,double likelihood_intresting,double
likelihood_boring,
double loss_function_taking,double loss_function_droping){
...
private void setModelDataLabelBad(double prior_p,double likelihood_intresting,double
likelihood_boring,double loss_function_taking,double loss_function_droping){
